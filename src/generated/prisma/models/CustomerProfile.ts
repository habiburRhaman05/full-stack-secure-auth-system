...
export type CustomerProfileWhereInput = {
  ...
  bio?: Prisma.StringNullableFilter<"CustomerProfile"> | string | null
  phoneNumber?: Prisma.StringNullableFilter<"CustomerProfile"> | string | null
  phoneVerified?: Prisma.BoolFilter<"CustomerProfile"> | boolean
...
export type CustomerProfileScalarWhereWithAggregatesInput = {
  ...
  bio?: Prisma.StringNullableWithAggregatesFilter<"CustomerProfile"> | string | null
  phoneNumber?: Prisma.StringNullableWithAggregatesFilter<"CustomerProfile"> | string | null
  phoneVerified?: Prisma.BoolWithAggregatesFilter<"CustomerProfile"> | boolean
...
export type CustomerProfileOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "avatarUrl" | "bio" | "phoneNumber" | "phoneVerified" | "dateOfBirth" | "createdAt" | "updatedAt", ExtArgs["result"]["customerProfile"]>
...
export interface CustomerProfileDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const customerProfileWithUserIdOnly = await prisma.customerProfile.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many CustomerProfiles and only return the `userId`
   * const customerProfileWithUserIdOnly = await prisma.customerProfile.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more CustomerProfiles and only return the `userId`
   * const customerProfileWithUserIdOnly = await prisma.customerProfile.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface CustomerProfileFieldRefs {
  ...
  readonly bio: Prisma.FieldRef<"CustomerProfile", 'String'>
  readonly phoneNumber: Prisma.FieldRef<"CustomerProfile", 'String'>
  readonly phoneVerified: Prisma.FieldRef<"CustomerProfile", 'Boolean'>
